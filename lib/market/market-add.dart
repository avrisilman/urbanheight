...
class MarketAdd extends StatefulWidget {
  @override
  _MarketAddPageState createState() => new _MarketAddPageState();
}

class _MarketAddPageState extends State<MarketAdd> {
  File _imageFile;
  String _base64 = '0';
  ...
  void save() async {
    ...
    var url = Api.serviceApi + '/api/market/'+prefs.getInt("usersId").toString()+"/sub/"+prefs.getInt("subId").toString();
