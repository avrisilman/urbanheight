...
class HistoriDetailHobi extends StatefulWidget {
  @override
  _HistoriDetailHobiState createState() => new _HistoriDetailHobiState();
}

class _HistoriDetailHobiState extends State<HistoriDetailHobi> {
  ...
  Future<String> makeRequest() async {
    ...
    setState(() {
      ...
      kondisiController.text = prefs.getString("time");
      hargaController.text = prefs.getString("date");
  ...
  void onDelete() async {
    var url =
        Api.serviceApi + '/api/hobi/' + prefs.getInt("hobiId").toString();
