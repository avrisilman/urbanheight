...
class HistoriDetailSewa extends StatefulWidget {
  @override
  _HistoriDetailSewaState createState() => new _HistoriDetailSewaState();
}

class _HistoriDetailSewaState extends State<HistoriDetailSewa> {
  ...
  Future<String> makeRequest() async {
    ...
    setState(() {
      ...
      kondisiController.text = prefs.getString("lamaPinjam");
  ...
  void onDelete() async {
    var url =
        Api.serviceApi + '/api/sewa-alat/' + prefs.getInt("sewaId").toString();
