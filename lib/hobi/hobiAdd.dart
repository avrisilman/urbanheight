...
class HobiAdd extends StatefulWidget {
  @override
  _HobiAddPageState createState() => new _HobiAddPageState();
}

class _HobiAddPageState extends State<HobiAdd> {
  File _imageFile;
  String _base64 = '0';
  ...
  void save() async {
    ...
    var url = Api.serviceApi + '/api/hobi/'+prefs.getInt("usersId").toString()+"/sub/"+prefs.getInt("subId").toString();
    ...
    return Scaffold(
        ...
        body: Align(
          ...
          child: ListView(
            ...
            children: <Widget>[_buildImagePreview(), cmr, title, ket, btn],
          ),
        ));
  }
