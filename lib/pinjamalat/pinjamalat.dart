...
import 'package:urbanheight/pinjamalat/pinjamalat-detail.dart';
import 'package:urbanheight/pinjamalat/pinjamalat.dart';
import 'package:urbanheight/pinjamalat/pinjamalatAdd.dart';
import 'package:urbanheight/service/api.dart';

class PinjamAlat extends StatefulWidget {
  @override
  _PinjamAlatState createState() => new _PinjamAlatState();
}
...
class _PinjamAlatState extends State<PinjamAlat> {
  ...
  Future<String> makeRequest() async {
    ...
    String url = Api.serviceApi + '/api/sewa-alat/'+prefs.getInt("subId").toString();

    var response = await http.get(Uri.encodeFull(url),
        headers: {'authorization': prefs.getString("token")});

    setState(() {
      sewa = prefs.getString("sewa");
                ...
                onPressed: () => _onAdd())
                  ...
                  _onTileClicked(
                    ...
                    Navigator.of(context).push(new MaterialPageRoute(
                      builder: (BuildContext context) => new PinjamDetail(),
                    ));
                    }
                
                  _onAdd() {
                     Navigator.of(context).push(new MaterialPageRoute(
                          builder: (BuildContext context) => new PinjamAlatAdd(),
                        ));
                  }
}
